<div
class="sidebar dark:bg-coal-600  rounded-md bg-light border-e border-e-gray-200 dark:border-e-coal-100 fixed z-20 flex flex-col items-stretch shrink-0 "
data-drawer="true" data-drawer-class="drawer drawer-start top-0 bottom-0" data-drawer-enable="true|lg:false"
id="sidebar" style="">

<div class="sidebar-header flex items-center relative justify-between px-3 lg:px-6 shrink-0 text-2xl my-[3%] me-5"
  id="sidebar_header">

  <button class="btn btn-icon btn-light btn-clear btn-md flex lg:hidden" data-drawer-toggle="#sidebar">
...
<hr class="my-4 border-t border-zinc-950/5 lg:-mx-4 dark:border-white/5">


<div class="sidebar-content flex grow shrink-0 py-3 pe-2" id="sidebar_content">
  <div class="scrollable-y-hover grow shrink-0 ps-3 pe-3 lg:ps-3 lg:pe-3 flex flex-col" data-scrollable="true"
    ...
    <div class="menu flex flex-col grow gap-2" data-menu="true" data-menu-accordion-expand-all="false"
      id="sidebar_menu">

      <div class="menu-item">
        <a href="/"
          class="menu-link flex items-center grow cursor-pointer border border-transparent gap-[10px] ps-[10px] pe-[10px] py-[6px]">
          <span class="menu-icon items-start text-gray-800 dark:text-gray-400 w-[20px]">
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
              stroke="currentColor" class="size-5">
    ...
    <div class="logout light:border-gray-300 max-w-[250px] mt-auto">
